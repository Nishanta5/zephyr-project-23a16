...
class PatientHome extends Component {
    ...
    componentDidMount() {
        ...
        axios
            ...
            .then((res) => {
                console.log("dddddd", JSON.stringify(res.data));
                this.setState({
    ...
    render() {
        return (
            <div className="bg-dark">
                <Navber />
                <h2 className="text-white my-3" align="center">
                    Patient Home
                </h2>
                            ...
                            >
                                ...
                                <div className="card-body card-body-cascade text-center">
                                    ...
                                    <p className="card-text">
                                        The doctor currently assigned to the
                                        patient
                                    </p>
                                </div>
                            </div>
